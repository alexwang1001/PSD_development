...
specificity_GESA_res_human_PFC <- read.csv(file = "Results/age_specificity_GESA_comparison/specificity_GESA_res_human.csv",header = TRUE, row.names = 1)
specificity_GESA_res_human_PFC$Species <- "Human PFC"

specificity_GESA_res_human_V1 <- read.csv(file = "Results/age_specificity_GESA_comparison/specificity_GESA_res_human_BA17.csv",header = TRUE, row.names = 1)
specificity_GESA_res_human_V1$Species <- "Human V1"
...
specificity_GESA_res <- rbind(specificity_GESA_res_human_PFC,
                              specificity_GESA_res_human_V1,
                              specificity_GESA_res_macaque,
                              specificity_GESA_res_mouse)
...
ggsave(filename = "Results/age_specificity_GESA_comparison/dotplot.pdf", width = 13, height = 6, units = "in")
